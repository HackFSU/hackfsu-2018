...
urlpatterns = [
    ...
    url(r'user/get/events$', views.user.get.EventsView.as_view(), name='user-get-events'),
    ...
    url(r'judge/hacks$', views.judge.GetHacksView.as_view()),
    url(r'judge/hacks/upload$', views.judge.PostHacksView.as_view()),
